...
import HardwareShowreel from '@/app/components/sections/HardwareShowreel'
...
export default function HardwarePage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-dark-bg via-dark-surface to-dark-bg overflow-hidden">
      <Navigation currentPath="hardware" onNavigate={() => {}} />
      
      {/* Hardware Showreel Section */}
      <HardwareShowreel id="hardware" />
